...
public class RegisterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.radioGroup=this.findViewById(R.id.gender);
        ...
        this.radioButton=findViewById(radioGroup.getCheckedRadioButtonId());
                        ...
                        try{
                          ...
                          User new_user=new User(userMail,userName,userPassword);
                            if (userManager.insertUser(new_user)==-1){
                                Toast.makeText(getApplicationContext(),"User already exists!"+userManager.insertUser(new_user),Toast.LENGTH_LONG).show();
                            }
                            else{
